...
local uiachievement = Class(Widget, function(self, owner)
	...
	self.mainui.achievement_bg.close.label:SetMultilineTruncatedString(STRINGS.GUI["close"], 1, 100, 50, "", true, 20)
    ...
    --self.mainbutton.levelbadge:SetHoverText(STRINGS.GUI["viewA"],{ size = 9, offset_x = 90, offset_y = -55, colour = {1,1,1,1}})
    ...
    self.mainbutton.coinbutton:SetHoverText(STRINGS.GUI["viewR"],{ size = 9, offset_x = 15, offset_y = -55, colour = {1,1,1,1}})
	...
	self.mainbutton.configlanguage:SetHoverText(STRINGS.GUI["changeL"],{ size = 9, offset_x = 0, offset_y = -55, colour = {1,1,1,1}})
	...
	local languagelist = { "English", "Korean", "Portugese (Brazil)", "simplified Chinese", "Russian", "Vietnamese", "French", "Italian"}
	local shortlist = { "en", "kr", "ptbr", "chs", "ru", "vi", "fr", "it"}
	...
	for i, language in ipairs(languagelist) do
		...
		languagebuttons[i].label:SetMultilineTruncatedString(language, 1, 110, 50, "", true)
	...
	self.mainui.infobutton.cat4.label:SetMultilineTruncatedString(STRINGS.GUI["have"], 1, 120, 50, "", true)
	...
	self.mainui.infobutton.cat5.label:SetMultilineTruncatedString(STRINGS.GUI["like"], 1, 120, 50, "", true)
	...
	self.mainui.infobutton.cat6.label:SetMultilineTruncatedString(STRINGS.GUI["pain"], 1, 120, 50, "", true)
	...
	self.mainui.infobutton.cat7.label:SetMultilineTruncatedString(STRINGS.GUI["fight"], 1, 120, 50, "", true)
	...
	self.mainui.perk_cat.perkcat1.label:SetMultilineTruncatedString(STRINGS.GUI["attributes"], 1, 150, 50, "", true)
	...
	self.mainui.perk_cat.perkcat2.label:SetMultilineTruncatedString(STRINGS.GUI["abilities"], 1, 150, 50, "", true)
	...
	self.mainui.perk_cat.perkcat3.label:SetMultilineTruncatedString(STRINGS.GUI["crafting"], 1, 150, 50, "", true)
	...
	self.mainui.levelbg.reset.label:SetMultilineTruncatedString(STRINGS.GUI["reset"], 1, 100, 50, "", true)
	...
	self.mainui.removeinfoXP.removeyes.label:SetMultilineTruncatedString(STRINGS.GUI["reset"], 1, 70, 50, "", true)
	...
	self.mainui.removeinfoXP.removeno.label:SetMultilineTruncatedString(STRINGS.GUI["close"], 1, 70, 50, "", true)
	...
	self.mainui.levelbg.close.label:SetMultilineTruncatedString(STRINGS.GUI["close"], 1, 100, 50, "", true)
	...
	self.mainui.levelbg.levelupbuttons.plushunger.label:SetString("+"..hungerGain)
	...
	self.mainui.levelbg.levelupbuttons.plussanity.label:SetString("+"..sanityGain)
	...
	self.mainui.levelbg.levelupbuttons.plushealth.label:SetString("+"..healthGain)
	...
	self.mainui.levelbg.levelupbuttons.plusdamage.label:SetString("+"..damageGain*100 .."%")
	...
	self.mainui.levelbg.levelupbuttons.plusdefence.label:SetString("+"..absorbGain*100 .."%")
	...
	self.mainui.levelbg.levelupbuttons.plusspeed.label:SetString("+"..speedGain*100 .."%")
	...
	self.mainui.levelbg.levelupbuttons.plusheat.label:SetString("+"..insulationGain)
	...
	self.mainui.levelbg.levelupbuttons.pluscold.label:SetString("+"..insulationGain)
...
function uiachievement:changeLanguage(language)
	package.loaded["translations/translation_kr"] = nil
	package.loaded["translations/translation_ptbr"] = nil
	package.loaded["translations/translation_es"] = nil
	package.loaded["translations/translation_it"] = nil
	package.loaded["translations/translation_chs"] = nil
	package.loaded["translations/translation_cht"] = nil
	package.loaded["translations/translation_ru"] = nil
	package.loaded["translations/translation_de"] = nil
	package.loaded["translations/translation_vi"] = nil
	package.loaded["translations/translation_pl"] = nil
	package.loaded["translations/translation_fr"] = nil
	package.loaded["translations/translation_en"] = nil
...
function uiachievement:buildpage(j,i)
	...
	self.achivlisttile[i].desc:SetTruncatedString(STRINGS.ACHIEVEMENTS[self.achivlist[i].name]["description"], 250, 500, "")
	line = self.achivlisttile[i].desc:GetString()
	while #line < #STRINGS.ACHIEVEMENTS[self.achivlist[i].name]["description"] do
...
function uiachievement:build_perkpage(j,i, adaptivecost)
	...
	self.coinlistbutton[i]:SetOnClick(function()
		...
		self.owner:DoTaskInTime(.3, function()
			self:loadcoinlist()
			self.coinlistbutton[i]:SetHoverText(STRINGS.GUI["obta"]..self.coinlist[i].current)
			self:perk_build()
		end)
	end)
	...
	self.coinlistbutton[i].name:SetTruncatedString(STRINGS.PERKS[self.coinlist[i].name]["name"], 220, 500, "")
	local line = self.coinlistbutton[i].name:GetString()
	while #line < #STRINGS.PERKS[self.coinlist[i].name]["name"] do
	...
	self.coinlistbutton[i].desc:SetMultilineTruncatedString(STRINGS.PERKS[self.coinlist[i].name]["description"], 2, 260, 500, "", true)
...
function uiachievement:updateAllStrings()
	...
	self.mainui.achievement_bg.close.label:SetMultilineTruncatedString(STRINGS.GUI["close"], 1, 100, 50, "", true)
