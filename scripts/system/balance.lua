...
giantPlantList = { "carrot_oversized", "corn_oversized", "potato_oversized" , "tomato_oversized",
"asparagus_oversized","eggplant_oversized","pumpkin_oversized","watermelon_oversized","dragonfruit_oversized","durian_oversized",
"garlic_oversized","onion_oversized","pepper_oversized","pomegranate_oversized"
}

heatfood = {"pepperpopper","dragonpie", "honeyham", "kabobs", "hotchili", "stuffedeggplant", "turkeydinner", "dragonchilisalad", "winter_food8", "winter_food7"}
