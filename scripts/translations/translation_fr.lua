...
STRINGS.GUI={
    ...
    ["close"] = "Fermer",
    ["reset"] = "Reset",
    ["resetPerks"] = "Faire un reset retirera toutes les récompenses et redonnera 100% des points de succès. Vous aurez également une pénalité temporaire de vie.",
    ["food"] = "Manger",
    ["life"] = "Vie",
    ["work"] = "Travail",
    ["have"] = "Objets",
...
STRINGS.ACHIEVEMENTS={
    ...
    ["eathot"] = {
        ...
        ["info"] = "a mangé de la nourriture et s'est rechauffé de l'Hypothermie "..allachiv_eventdata["eathot"].." fois",
    },
    ["eatcold"] = {
        ["name"] = "Journée chaude et ensoleillée",
        ["description"] = "Manger "..allachiv_eventdata["eatcold"].." repas pour vous refroidir",
        ["info"] = "a mangé de la nourriture et s'est refroidi de l'Insolation "..allachiv_eventdata["eatcold"].." fois",
    },
    ["eatfish"] = {
        ["name"] = "Pescetarien",
...
STRINGS.PERKS={
    ...
    ["crit"] = {
        ["name"]="Coup critique +",
        ["description"]="Augmente les chances de doubler les dégâts par "..(math.ceil(allachiv_coindata["crit"]*100)).."%",
    },
    ["lifesteal"] = {
        ["name"]="Vol de vie +",
        ["description"]="Augmente le vol de vie par "..(math.ceil(allachiv_coindata["lifesteal"]*1000)/10).."% de vos dégâts",
    },
    ["scale"] = {
        ["name"]="Taille +",
    ...
    ["krampusxmas"] = {
        ["name"]="Noël",
        ["description"]="Augmente l'apparition du Sac de Krampus par "..(math.ceil(allachiv_coindata["krampusxmas"]*100)).."%",
    },
    ["fireflylightup"] = {
        ["name"]="Pénombre +",
    ...
    ["cheatdeath"] = {
        ...
        ["description"]="Une fois tout les "..(allachiv_coindata["cheatdeath"]/60).." minutes, vous refusez de mourir",
    },
    ["naturalist"] = {
        ["name"]="Naturaliste",
