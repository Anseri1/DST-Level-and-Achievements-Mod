...
["close"] = "Закрыть",
["reset"] = "Сбросить",
["resetPerks"] = "Сброс удалит все вознаграждения и вернёт 100% очков достижений. Вы также получите временный штраф к здоровью.",
["food"] = "Еда",
["life"] = "Жизнь",
["work"] = "Работа",
["have"] = "Пожитки",
...
STRINGS.ACHIEVEMENTS={
    ...
    ["eathot"] = {
        ...
        ["description"] = "Съешьте "..allachiv_eventdata["eathot"].." горячих блюд, чтобы согреться",
        ["info"] = "съел горячие блюда, чтобы согреться "..allachiv_eventdata["eathot"].." раз",
    },
    ["eatcold"] = {
        ["name"] = "Жаркий солнечный день",
        ["description"] = "Съешьте "..allachiv_eventdata["eatcold"].." холодных блюд, чтобы остыть",
        ["info"] = "съел холодные блюда, чтобы остыть "..allachiv_eventdata["eatcold"].." раз",
    },
    ["eatfish"] = {
        ["name"] = "Пескатарианец",
    ...
    ["eatpepper"] = {
        ...
        ["description"] = "Съешьте "..allachiv_eventdata["eatpepper"].." фаршированных перцев",
    ...
    ["messiah"] = {
        ["name"] = "Мессия",
        ["description"] = "Воскресите других игроков "..allachiv_eventdata["messiah"].." раз",
        ["info"] = "воскресил других игроков по крайней мере "..allachiv_eventdata["messiah"].." раз",
    },
    ["sleeptent"] = {
        ["name"] = "Милый дом",
    ...
    ["reviveamulet"] = {
        ["name"] = "Отражение",
        ["description"] = "Воскресните "..allachiv_eventdata["reviveamulet"].." раза Животворящим амулетом",
        ["info"] = "воскресил "..allachiv_eventdata["reviveamulet"].." раза Животворящим амулетом",
    },
    ["feedplayer"] = {
        ["name"] = "Заботливый мишка",
        ["description"] = "Накормите игроков "..allachiv_eventdata["feedplayer"].." раз блюдом",
    ...
    ["nature"] = {
        ...
        ["info"] = "посадил по крайней мере "..allachiv_eventdata["nature"].." деревьев или семян в землю",
    },
    ["fishmaster"] = {
        ["name"] = "Рыбак",
    ...
    ["chopappren"] = {
        ["name"] = "Мистер Бобр",
        ["description"] = "Срубите или выкопайте "..allachiv_eventdata["chopappren"].." деревьев",
        ["info"] = "вырубил или выкопал по крайней мере "..allachiv_eventdata["chopappren"].." деревьев",
    },
    ["chopmaster"] = {
    ...
    ["cookappren"] = {
        ...
        ["info"] = "приготовил по крайней мере "..allachiv_eventdata["cookappren"].." блюд в казане",
    },
    ["cookmaster"] = {
        ["name"] = "Пожиратель Рамси",
        ["description"] = "Приготовьте "..allachiv_eventdata["cookmaster"].." блюд в казане",
        ["info"] = "приготовил по крайней мере "..allachiv_eventdata["cookmaster"].." блюд в казане",
    },
    ["buildappren"] = {
        ["name"] = "Ремесленник",
    ...
    ["emerald"] = {
        ["name"] = "Изумруд",
        ["description"] = "Получите "..allachiv_eventdata["emerald"].." зеленых драгоценных камней",
        ["info"] = "имеет "..allachiv_eventdata["emerald"].." зеленых драгоценных камней",
    },
    ["citrin"] = {
        ["name"] = "Цитрин",
        ["description"] = "Получите "..allachiv_eventdata["citrin"].." желтых драгоценных камней",
        ["info"] = "имеет "..allachiv_eventdata["citrin"].." желтых драгоценных камней",
    },
    ["amber"] = {
        ["name"] = "Янтарь",
        ["description"] = "Получите "..allachiv_eventdata["amber"].." оранжевых драгоценных камней",
        ["info"] = "имеет "..allachiv_eventdata["amber"].." оранжевых драгоценных камней",
    },
    ["saddle"] = {
        ["name"] = "Дикая поездка",
    ...
    ["banana"] = {
        ["name"] = "Мартышкин труд",
        ["description"] = "Получите "..allachiv_eventdata["banana"].." приготовленных пещерных бананов",
        ["info"] = "имеет "..allachiv_eventdata["banana"].." приготовленных пещерных бананов",
    },
    ["spore"] = {
        ["name"] = "Поймай грибок",
        ["description"] = "Получите "..allachiv_eventdata["spore"].." красных, зеленых и синих спор",
        ["info"] = "имеет "..allachiv_eventdata["spore"].." красных, зеленых и синих спор",
    },
    ["blueprint"] = {
        ["name"] = "Архитектор",
    ...
    ["evil"] = {
        ...
        ["info"] = "подружился по крайней мере с "..allachiv_eventdata["evil"].." мандрагорами",
    },
    ["birdclop"] = {
    ...
    ["starve"] = {
        ...
        ["description"] = "Голодайте в течении "..(allachiv_eventdata["starve"]/60).." минут",
        ["info"] = "голодал в течении "..(allachiv_eventdata["starve"]/60).." минут",
    },
    ["nosanity"] = {
        ["name"] = "Параноик",
        ["description"] = "Будьте безумным в течении "..(allachiv_eventdata["nosanity"]/60).." минут",
        ["info"] = "оставался совершенно безумным по крайней мере "..(allachiv_eventdata["nosanity"]/60).." минут",
    },
    ["icebody"] = {
        ["name"] = "Переохлаждение",
        ["description"] = "Оставайтесь замерзнувшим в течении "..(allachiv_eventdata["icebody"]/60).." минут",
        ["info"] = "оставался замерзнувшим в течении "..(allachiv_eventdata["icebody"]/60).." минут",
    },
    ["firebody"] = {
        ["name"] = "Расплавленное тело",
        ["description"] = "Оставайтесь перегревшимся в течении "..(allachiv_eventdata["firebody"]/60).." минут",
        ["info"] = "оставался перегревшимся в течении "..(allachiv_eventdata["firebody"]/60).." минут",
    },
    ["moistbody"] = {
        ["name"] = "Насквозь промокший",
        ["description"] = "Оставайтесь промокшим в течении "..(allachiv_eventdata["moistbody"]/60).." минут",
        ["info"] = "оставался промокшим насквозь в течении "..(allachiv_eventdata["moistbody"]/60).." минут",
    },
    ["evilflower"] = {
        ["name"] = "Злые цветы",
    ...
    ["dmgnodmg"] = {
        ...
        ["description"] = "Нанесите "..(allachiv_eventdata["dmgnodmg"]/1000).."к урона без повреждений",
        ["info"] = "уклонился от всех атак и нанес "..allachiv_eventdata["dmgnodmg"].." урона",
    },
    ["bullkelp"] = {
        ["name"] = "Влепи им",
        ["description"] = "Нанесите "..(allachiv_eventdata["bullkelp"]/1000).."к урона Стеблем ламинарии",
        ["info"] = "нанес врагам "..allachiv_eventdata["bullkelp"].." урона Стеблем ламинарии",
    },
    ["butcher"] = {
        ["name"] = "Мясник",
        ["description"] = "Убейте "..allachiv_eventdata["butcher"].." Бифало в сезон размножения",
        ["info"] = "убил по крайней мере "..allachiv_eventdata["butcher"].." Бифало в сезон размножения",
    },
    ["horrorhound"] = {
        ["name"] = "Зомби",
    ...
    ["fruitdragon"] = {
        ...
        ["description"] = "Убейте "..allachiv_eventdata["fruitdragon"].." созревшую Салатмандру",
        ["info"] = "убил "..allachiv_eventdata["fruitdragon"].." разгневанную Салатмандру",
    },
    ["sick"] = {
        ["name"] = "Бессердечный",
    ...
    ["goatperd"] = {
        ...
        ["info"] = "убил по крайней мере "..allachiv_eventdata["goatperd"].." заряженных Вольт-коз",
    },
    ["mossling"] = {
        ["name"] = "Куриный ужин",
        ["description"] = "Убейте "..allachiv_eventdata["mossling"].." спокойных Лусят",
        ["info"] = "убил по крайней мере "..allachiv_eventdata["mossling"].." спокойных Лусят",
    },
    ["weetusk"] = {
        ["name"] = "Никакой пощады",
        ["description"] = "Убейте "..allachiv_eventdata["weetusk"].." младших МакБивней",
        ["info"] = "убил по крайней мере "..allachiv_eventdata["weetusk"].." младших МакБивней",
    },
    ["snake"] = {
        ["name"] = "Медуза",
    ...
    ["hentai"] = {
        ...
        ["description"] = "Убейте в одиночку "..allachiv_eventdata["hentai"].." Гигантских щупалец",
        ["info"] = "убил в одиночку по крайней мере "..allachiv_eventdata["hentai"].." Гигантских щупалец без последователей",
    },
    ["treeguard"] = {
        ["name"] = "Волшебный лес",
    ...
    ["trader"] = {
        ["name"] = "Трейдер",
        ["description"] = "Продайте "..allachiv_eventdata["trader"].." безделушек за золото",
        ["info"] = "продал безделушки за сладкие блестящие золотые самородки",
    },
    ["fuzzy"] = {
        ["name"] = "Пушистый друг",
        ["description"] = "Накормите Муравьиного льва "..allachiv_eventdata["fuzzy"].." термальными камнями",
    ...
    ["stopalot"] = {
        ...
        ["info"] = "оставался неподвижным по крайней мере "..(allachiv_eventdata["stopalot"]/60).." минут",
    },
    ["caveage"] = {
        ["name"] = "Пещерный человек",
        ["description"] = "Оставайтесь "..(allachiv_eventdata["caveage"]/60).." минут в пещерах",
        ["info"] = "находился в пещерах в течении "..(allachiv_eventdata["caveage"]/60).." минут",
    },
    ["rider"] = {
        ["name"] = "Ковбой",
        ["description"] = "Катайтесь верхом на Бифало в течении "..(allachiv_eventdata["rider"]/60).." минут",
        ["info"] = "катался верхом на Бифало на протяжении "..(allachiv_eventdata["rider"]/60).." минут",
    },
    ["fullsanity"] = {
        ["name"] = "Совершенный",
        ["description"] = "Держите рассудок >95% на протяжении "..(allachiv_eventdata["fullsanity"]/60).." минут",
        ["info"] = "сохранял ясный рассудок на протяжении "..(allachiv_eventdata["fullsanity"]/60).." минут",
    },
    ["fullhunger"] = {
        ["name"] = "Обжора",
        ["description"] = "Держите сытось >95% на протяжении "..(allachiv_eventdata["fullhunger"]/60).." минут",
        ["info"] = "был сыт на протяжении "..(allachiv_eventdata["fullhunger"]/60).." минут",
    },
    ["pacifist"] = {
        ["name"] = "Пацифист",
        ["description"] = "Не наносите урон на протяжении "..(allachiv_eventdata["pacifist"]/60).." минут",
        ["info"] = "не наносил урон на протяжении "..(allachiv_eventdata["pacifist"]/60).." минут",
    },
	["allgiantPlants"] = {
...
STRINGS.PERKS={
    ...
    ["hungerrateup"] = {
        ["name"]="Уровень голода -",
        ["description"]="Снизить уровень голода на "..(math.ceil(allachiv_coindata["hungerrateup"]*100)).."%",
    },
    ["sanityregen"] = {
        ["name"]="Восстановление рассудка +",
        ["description"]="Повысить восстановление расудка на "..allachiv_coindata["sanityregen"].."/5с",
    },
    ["healthregen"] = {
        ["name"]="Восстановление здоровья +",
        ["description"]="Повысить восстановление здоровья на "..allachiv_coindata["healthregen"].."/5с",
    },
    ["damageup"] = {
        ["name"]="Урон +",
    ...
    ["crit"] = {
        ...
        ["description"]="Увеличить шанс нанести двойной урон на "..(math.ceil(allachiv_coindata["crit"]*100)).."%",
    },
    ["lifesteal"] = {
        ["name"]="Кража жизни +",
        ["description"]="Увеличить вампиризм на "..(math.ceil(allachiv_coindata["lifesteal"]*1000)/10).."% Вашего урона",
    },
    ["scale"] = {
        ["name"]="Шкала +",
        ["description"]="Увеличить размер вашего персонажа на "..(math.ceil(allachiv_coindata["scale"]*100)).."%",
    },
    ["speedup"] = {
        ["name"]="Скорость +",
        ["description"]="Увеличить скорость передвижения на "..(math.ceil(allachiv_coindata["speedup"]*100)).."%",
    },
    ["absorbup"] = {
        ["name"]="Защита +",
    ...
    ["krampusxmas"] = {
        ["name"]="Рождество",
        ["description"]="Увеличить шанс выпадения Мешка крампуса до "..(math.ceil(allachiv_coindata["krampusxmas"]*100)).."%",
    },
    ["fireflylightup"] = {
        ["name"]="Тусклый свет +",
    ...
    ["cheatdeath"] = {
        ...
        ["description"]="Один раз в каждые "..(allachiv_coindata["cheatdeath"]/60).." минут Вы отказываетесь умирать",
    },
    ["naturalist"] = {
