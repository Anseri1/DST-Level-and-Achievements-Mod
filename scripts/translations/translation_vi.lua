...
STRINGS.GUI={
    ...
    ["close"] = "Đóng",
    ["reset"] = "Đặt lại",
    ["resetPerks"] = "Đặt lại sẽ xóa tất cả phần thưởng và hoàn lại 100% tổng điểm. Bạn cũng sẽ nhận 1 phần máu đen.",
    ["food"] = "Ăn",
    ["life"] = "Sống",
    ["work"] = "Làm",
    ["have"] = "Sở hữu",
...
STRINGS.ACHIEVEMENTS={
    ...
    ["eatcold"] = {
        ...
        ["info"] = "đã ăn đồ làm mát bản thân khỏi quá nhiệt "..allachiv_eventdata["eatcold"].." lần",
    },
    ["eatfish"] = {
        ["name"] = "Pescatarian",
    ...
    ["dmgnodmg"] = {
        ["name"] = "Thánh né",
        ["description"] = "gây ra "..(allachiv_eventdata["dmgnodmg"]/1000).."k damage và né toàn bộ đòn tấn công",
    ...
    ["hentai"] = {
        ...
        ["info"] = "đã một mình giết "..allachiv_eventdata["hentai"].." xúc tu khổng lồ mà không cần giúp đỡ",
    },
    ["treeguard"] = {
        ["name"] = "Khu rừng bí ẩn",
...
STRINGS.PERKS={
    ...
    ["lifesteal"] = {
        ["name"]="Hút máu +",
        ["description"]="tăng tỷ lệ hút máu lên "..(math.ceil(allachiv_coindata["lifesteal"]*1000)/10).."% of your damage",
    },
    ["scale"] = {
        ["name"]="kích cỡ +",
    ...
    ["krampusxmas"] = {
        ["name"]="Giáng sinh",
        ["description"]="Tăng cơ hội rơi rơi Krampus sack lên "..(math.ceil(allachiv_coindata["krampusxmas"]*100)).."%",
    },
    ["fireflylightup"] = {
        ["name"]="Phát sáng +",
    ...
    ["cheatdeath"] = {
        ["name"]="Cheat Death",
        ["description"]="cứ mỗi "..(allachiv_coindata["cheatdeath"]/60).." phút bạn từ chối cái chết",
    },
    ["naturalist"] = {
        ["name"]="Wormwood",
