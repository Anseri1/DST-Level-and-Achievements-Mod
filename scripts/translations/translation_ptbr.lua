...
STRINGS.GUI={
    ...
    ["close"] = "Fechar",
    ["reset"] = "Redefinir",
    ["resetPerks"] = "A redefinição removerá todas as recompensas e reembolsará 100% dos pontos de conquista. Você também receberá uma penalidade temporária de saúde.",
    ["food"] = "Comida",
    ["life"] = "Vida",
    ["work"] = "Trabalho",
    ["have"] = "Tem",
