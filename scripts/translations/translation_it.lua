...
STRINGS.GUI={
    ...
    ["close"]="Chiudi",
    ["reset"]="Ripristina",
    ["resetAchievments"]="Il ripristino rimuoverà tutte le ricompense e rimborserà100% di punti obiettivo. Riceverai anche una penalità di salute temporanea.",
    ["food"]="Cibo",
    ["life"]="Vita",
    ["work"]="Lavori",
    ["have"]="Have",
    ...
    ["attributeunits"]="\n\n%\n%\n%\n\n\n",
    ["resetlevel"]="Il ripristino rimuoverà tutti gli aggiornamenti e il rimborso100% punti. Riceverai anche una penalità di salute temporanea.",
...
STRINGS.ACHIEVEMENTS={
    ...
    ["eatcold"]={
        ...
        ["info"]="mangiato cibo e ti sei raffreddato dal surriscaldamento "..allachiv_eventdata["eatcold"].." times ",
    },
    ["eatfish"]={
        ["name"]="Pescatarian ",
    ...
    ["fullsanity"]={
        ["name"]="Sofisticato ",
        ["description"]="Mantieni una sanità mentale superiore al 95% per "..(allachiv_eventdata["fullsanity"]/60).." minuti ",
...
STRINGS.PERKS={
    ...
    ["sanityregen"]={
        ["name"]="Sanity Regen + ",
        ["description"]="Aumenta la rigenerazione della sanità mentale di "..allachiv_coindata["sanityregen"].."/5s ",
    },
    ["healthregen"]={
        ["name"]="Health Regen + ",
    ...
    ["crit"]={
        ["name"]="Colpo critico + ",
        ["description"]="Aumenta la possibilità di infliggere danni doppi di "..(math.ceil(allachiv_coindata["crit"]*100)).."%",
    },
    ["lifesteal"]={
        ["name"]="Lifesteal + ",
        ["description"]="Aumenta lifesteal di "..(math.ceil(allachiv_coindata["lifesteal"]*1000)/10).."% del tuo danno ",
    },
    ["scale"]={
        ["name"]="Scala + ",
        ["description"]="Aumenta le dimensioni del tuo personaggio di "..(math.ceil(allachiv_coindata["scale"]*100)).."%",
    },
    ["speedup"]={
        ["name"]="Velocità + ",
    ...
    ["krampusxmas"]={
        ["name"]="Natale",
        ["description"]="Aumenta la probabilità di caduta di Krampus Sack a "..(math.ceil(allachiv_coindata["krampusxmas"]*100)).."%",
    },
    ["fireflylightup"]={
        ["name"]="Luce fioca + ",
    ...
    ["cheatdeath"]={
        ["name"]="Cheat Death ",
        ["description"]="Una volta ogni "..(allachiv_coindata["cheatdeath"]/60).." minuti in cui ti rifiuti di morire ",
    },
    ["naturalist"]={
        ["name"]="Naturalista",
