...
STRINGS.GUI={
    ...
    ["close"] = "Close",
    ["reset"] = "Reset",
    ["resetPerks"] = "Resetting will remove all rewards and refund 100% of achievement points. You also get a temporary health penalty.",
    ["reset_achieve"] = "Reset all achievement progression to 0 and keep all the points you have earned thus far.\n requires at least "..allachiv_reset_event_data["required_achievements_for_reset"].." achievements and "..allachiv_reset_event_data["required_replaytoken_for_reset"].." reset token",
    ["food"] = "Food",
    ["life"] = "Life",
    ["work"] = "Work",
    ["have"] = "Have",
...
STRINGS.ACHIEVEMENTS={
    ...
    ["eye_of_terror"] = {
        ["name"] = "Pink Eye",
        ["description"] = "Slay the Eye of Terror",
        ["info"] = "killed eye of terror",
    },
    ["twins_of_terror"] = {
        ["name"] = "A Sight for Sore Eyes",
        ["description"] = "Slay the Twins of Terror",
        ["info"] = "killed twins of terror",
    },
    ["celestial_champion"] = {
        ["name"] = "Over the Moon",
        ["description"] = "Slay the Celestial Champion",
        ["info"] = "killed Celestial Champion",
    },
    ["varg"] = {
